...
on the linear interpolation of trigrams, bigrams, and unigrams is developed. The web-based application can be found <a href="https://shresthaprabesh.shinyapps.io/PredictMyNextWord/"> here</a> and the source files for this project can be found <a href="https://github.com/prabs15/Capstone_Milestone_Project"> here</a>. App user interface looks like this </small>
